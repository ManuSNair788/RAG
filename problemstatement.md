...
### 1. Corpus Definition
- **Selected Asset Management Companies (AMCs):**
  1. NJ Mutual Fund
  2. Abakkus Mutual Fund
  3. Choice Mutual Fund
  4. The Wealth Company Mutual Fund
  5. Capitalmind Mutual Fund
  6. JioBlackRock Mutual Fund
  7. Unifi Mutual Fund
  8. Helios Mutual Fund
  9. Bajaj Finserv Mutual Fund
  10. Navi Mutual Fund
- Choose 3–5 mutual fund schemes per AMC, ensuring category diversity (e.g., large-cap, flexi-cap, ELSS)
- Collect 15–25 official public URLs per AMC, including:
  - Scheme factsheets
